...
用法：
    python version_manager.py --action list --slug sunyuchen --base-dir ./personas
    python version_manager.py --action rollback --slug sunyuchen --version v2 --base-dir ./personas
    python version_manager.py --action cleanup --slug sunyuchen --base-dir ./personas
"""
...
def main():
    parser = argparse.ArgumentParser(description="人物 Skill 版本管理器")
    parser.add_argument("--action", required=True, choices=["list", "rollback", "cleanup"])
    parser.add_argument("--slug", required=True, help="人物 slug")
    parser.add_argument("--version", help="目标版本号（rollback 时使用）")
    parser.add_argument("--base-dir", default="./personas", help="人物 Skill 根目录")
